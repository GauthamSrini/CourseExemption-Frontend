...
const OnlineReportTable = () => {
  ...
  // Main Function to fetch all the Online completed datas
  const fetchAllDataOnline = async () => {
    try {
      const response = await axios.post(
        `${apiBaseUrl}/api/ce/FilterOnlineReport`,
        {
          headers: {
    ...
    <>
      <div className="TableTitleDiv">
        <div style={{ display: "flex" }}>
          <div className="tableTitle">Online Course</div>
...
export default OnlineReportTable;
