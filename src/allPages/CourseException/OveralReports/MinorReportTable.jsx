...
const MinorReportTable = () => {
  ...
  // Main Function to fetch all the Minor completed datas
  const fetchAllDataMinor = async () => {
    try {
      const response = await axios.post(
        `${apiBaseUrl}/api/ce/FilterMinorReport`,
        {
          headers: {
    ...
    <>
      <div className="TableTitleDiv">
        <div style={{ display: "flex" }}>
          <div className="tableTitle">Minor Courses</div>
...
export default MinorReportTable;
