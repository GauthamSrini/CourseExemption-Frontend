...
const AddonReportTable = () => {
  ...
  // Main Function to fetch all the Addon completed datas
  const fetchAllDataAddon = async () => {
    try {
      const response = await axios.post(
        `${apiBaseUrl}/api/ce/FilterAddonReport`,
        {
          headers: {
  ...
  // Function to feth the academic yearsc
    ...
    <>
      <div className="TableTitleDiv">
        <div style={{ display: "flex" }}>
          <div className="tableTitle">Addon Courses</div>
...
export default AddonReportTable;
