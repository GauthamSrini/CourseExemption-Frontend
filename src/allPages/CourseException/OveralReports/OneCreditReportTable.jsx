...
const OneCreditReportTable = () => {
  ...
  // Main Function to fetch all the One Credit completed datas
  const fetchAllDataOneCredit = async () => {
    try {
      const response = await axios.post(
        `${apiBaseUrl}/api/ce/FilterOneCreditReport`,
        {
          headers: {
    ...
    <>
      <div className="TableTitleDiv">
        <div style={{ display: "flex" }}>
          <div className="tableTitle">One Credit</div>
...
export default OneCreditReportTable;
